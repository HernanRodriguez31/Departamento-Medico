...
- Gemini API key for Functions (`GEMINI_API_KEY`).
...
- Gemini API key: stored as a Firebase Functions secret (`GEMINI_API_KEY`). Do not expose in HTML/JS.
...
3) Gemini API key
   ...
   - Update Firebase Functions secret `GEMINI_API_KEY`.
   - Redeploy Functions.
