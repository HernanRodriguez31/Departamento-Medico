...
const PRECACHE_URLS = [
  ...
  "/assets/css/pages/bitacora-cientifica.css?v=20260504-bitacora-document-agent-1",
  ...
  "/assets/js/pages/bitacora-cientifica.js?v=20260504-bitacora-document-agent-1",
  "/assets/js/data/bitacora-posts.js",
  "/assets/js/data/scientific-sources.js",
  "/assets/js/services/bitacora-article-repository.js",
  "/assets/js/services/bitacora-ai-extractor.js?v=20260504-bitacora-document-agent-1",
  "/assets/js/services/bitacora-article-repository.js?v=20260504-bitacora-document-agent-1",
